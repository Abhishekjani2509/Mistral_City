...
export function mountCity(el, opts = {}) {
  ...
  /* One wheel gesture is one step. A trackpad flick fires around 40 events and
     the old multiply-per-event turned that into a jump from 1 straight to 4.
     Cooldown runs on wall clock: rAF stops on a hidden tab. */
